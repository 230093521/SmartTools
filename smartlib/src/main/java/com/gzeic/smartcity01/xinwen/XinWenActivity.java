package com.gzeic.smartcity01.xinwen;
...
public class XinWenActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.news_base) {
            ...
            startActivity(new Intent(XinWenActivity.this, XinWenPingLunActivity.class));
        }
    }
}