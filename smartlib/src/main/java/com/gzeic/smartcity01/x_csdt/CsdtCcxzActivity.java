...
public class CsdtCcxzActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csdt_ccxz);
        initView();
        getCcxz();
    ...
    private void getCcxz() {
        getTools().sendGetRequestToken("http://" + getServerIp() + "/prod-api/api/metro/statement?type=1", getToken(), new Callback() {
            @Override
