...
public class JfRqfjflsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jf_rqfjfls);
        initView();
    ...
    private void getJfls() {
        getTools().sendGetRequestToken("http://" + getServerIp() + "/prod-api/api/living/recharge/record/list?categoryId=4&pageNum=1&pageSize=8", getToken(), new Callback() {
            @Override
                        ...
                        public void run() {
                            ...
                            list.setAdapter(new BaseAdapter() {
                                ...
                                public View getView(int position, View convertView, ViewGroup parent) {
                                    View view = LayoutInflater.from(JfRqfjflsActivity.this).inflate(R.layout.item_jf_sf_jfls, null);
                                    final JFdsrBean.RowsDTO rowsDTO = finalRows.get(position);
                                    ViewHolder viewHolder = new ViewHolder(view);
                                    viewHolder.jine.setText("缴费金额:" + rowsDTO.getAmount() + "");
                                    viewHolder.sfh.setText("燃气费号:" + rowsDTO.getPaymentNo());
