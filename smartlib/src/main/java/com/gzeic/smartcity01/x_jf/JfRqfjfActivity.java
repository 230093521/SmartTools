...
public class JfRqfjfActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lishi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(JfRqfjfActivity.this,JfRqfjflsActivity.class));
            }
        });
    }
    ...
    private void getQfje() {
        getTools().sendGetRequestToken("http://" + getServerIp() + "/prod-api/api/living/bill?paymentNo="+shuifeihao+"&categoryId=4", getToken(), new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
