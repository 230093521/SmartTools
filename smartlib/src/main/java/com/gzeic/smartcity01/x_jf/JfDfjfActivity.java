...
public class JfDfjfActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lishi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(JfDfjfActivity.this,JfDfjflsActivity.class));
            }
        });
    }
    ...
    private void getQfje() {
        getTools().sendGetRequestToken("http://" + getServerIp() + "/prod-api/api/living/bill?paymentNo="+shuifeihao+"&categoryId=3", getToken(), new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
