...
import com.xsonline.smartlib.bean.TinCheJiLuBean;
...
public class TinCheJiLuActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tin_che_ji_lu);
        initView();
        num = 1;
        initTinche();
    ...
    private void showshijian1() {
        TimePickerDialog timePickerDialog = new TimePickerDialog(TinCheJiLuActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    public void showriqi1() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(TinCheJiLuActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
