...
public class YangLaoCyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yang_lao_cy);
        initView();
        ...
        xunjianlist.setAdapter(new BaseAdapter() {
            ...
            public View getView(int i, View view, ViewGroup viewGroup) {
                ...
                viewHolder.fjm.setText("餐厅名");
                viewHolder.jiesu.setText(beans.getTime2());
                viewHolder.fangmin.setText(beans.getFangmin()+"号餐厅");
                return view;
            }
        });
    }
    ...
    private void initView() {
        ...
        xunjianlist = (ListView) findViewById(R.id.canyinlist);
    }
