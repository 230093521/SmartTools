...
//        getTools().sendGetRequest("http://" + getServerIp() + "/userinfo/rotation/lists?pageNum=1&pageSize=10&type=47", new Callback() {
//            @Override
//            public void onFailure(Call call, IOException e) {
//                runOnUiThread(new Runnable() {
//                    @Override
//                    public void run() {
//                        showToast("连接服务器失败，请设置网络");
//                        startActivity(new Intent(GuideActivity.this,SetNetworkActivity.class));
//                        finish();
//                    }
//                });
//            }
...
//                RowsListBean rowsListBean = new Gson().fromJson(json, RowsListBean.class);
//                if (rowsListBean.getCode() == 200) {
//                    imageList = new ArrayList<>();
//                    List<RowsBean> rows = rowsListBean.getRows();
//                    for (RowsBean rs : rows) {
//                        imageList.add("http://"+getServerIp()+rs.getImgUrl());
//                        Log.e(TAG, "http://"+getServerIp()+rs.getImgUrl());
//                    }
//                    showBanner();
//                } else {
